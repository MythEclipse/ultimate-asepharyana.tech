...
export const CardSkeleton = memo(({
  ...
  return (
    <div className={cn('animate-pulse overflow-hidden rounded-lg', getSkeletonVariant(), className)}>
      {showImage && (
        <div className={cn('bg-gray-200 dark:bg-gray-700', getImageHeight())} />
      )}
...
export const CompactCardSkeleton = (props: Omit<CardSkeletonProps, 'variant'>) => (
