    ...
    <main className='p-4 md:p-8 lg:p-12 bg-background text-foreground min-h-screen'>
      <div className='max-w-7xl mx-auto'>
        ...
        <section className='mb-12 space-y-6'>
          ...
          <UnifiedGrid items={displayData.data.ongoing_anime} itemType="anime" />
        </section>
        ...
        <section className='space-y-6'>
          ...
          <UnifiedGrid items={displayData.data.complete_anime} itemType="anime" />
        </section>
      </div>
    </main>
  );
...
export default memo(AnimePageClient);
