...
const loggers = {
  clientLogger: logger_1.default,
  serverLogger: serverLogger_1.default,
  unifiedLogger: unified_logger_1.default,
};
...
try {
  ...
  if (
    typeof clientLogError === 'function' &&
    typeof serverLogError === 'function'
  ) {
