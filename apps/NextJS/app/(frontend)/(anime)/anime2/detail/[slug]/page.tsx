          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="w-full md:w-2/3 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-zinc-50 dark:bg-zinc-800 rounded-xl">
                {[
                  { label: 'Type', value: anime.type, icon: <Type className="w-5 h-5 text-blue-500" /> },
                  { label: 'Status', value: anime.status, icon: <CircleDot className="w-5 h-5 text-green-500" /> },
                  { label: 'Released', value: anime.release_date, icon: <Calendar className="w-5 h-5 text-red-500" /> },
