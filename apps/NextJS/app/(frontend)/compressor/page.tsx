        ...
        <div className='border border-blue-500 ring ring-blue-500 shadow-lg rounded-xl p-6 bg-white dark:bg-black'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <button
              ...
              className={`w-full py-3 px-6 ${loading ? 'bg-blue-400' : 'bg-blue-600'} text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed`}
            >
