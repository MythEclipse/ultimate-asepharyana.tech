        ...
        <nav class="sticky top-0 z-[100] w-full backdrop-blur-3xl bg-background/70 border-b border-border/50">
            <div class="container mx-auto flex h-16 items-center justify-between px-8">
                ...
                <A href="/" class="flex items-center space-x-6 group">
                    <div class="relative">
                        <div class="absolute -inset-4 bg-primary/20 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 animate-pulse" />
                    ...
                    <div class="hidden sm:block space-y-0.5">
                        <span class="text-xl font-black italic tracking-tighter uppercase leading-none block group-hover:text-primary transition-colors">
                            "Asep" <span class="text-primary group-hover:text-foreground transition-colors">"Haryana"</span>
                        </span>
                ...
                <div class="hidden md:flex items-center space-x-2">
                     ...
                     <div class="w-8 h-px bg-border/50 mx-4" />

                     // Theme Engine
                     <button
                        on:click=cycle_theme
                        class="p-4 rounded-2xl hover:bg-muted/50 transition-all group relative overflow-hidden active:scale-95"
                     ...
                     <Show
                        ...
                        fallback=|| view! {
                             <A href="/login" class="ml-4 px-8 py-3.5 text-[10px] font-black uppercase tracking-[0.3em] rounded-2xl bg-foreground text-background hover:scale-105 active:scale-95 transition-all shadow-2xl relative group/auth overflow-hidden border border-border/20">
                                <span class="relative z-10">"Login"</span>
                                <div class="absolute inset-0 bg-gradient-to-r from-primary to-accent opacity-0 group-hover/auth:opacity-20 transition-opacity" />
                             </A>
                        }
                     >
                        <div class="flex items-center gap-4 ml-4">
                             <A href="/dashboard" class="px-8 py-3.5 text-[10px] font-black uppercase tracking-[0.3em] rounded-2xl glass border border-primary/20 text-primary hover:bg-primary/5 hover:border-primary/40 transition-all active:scale-95">
                                "Dashboard"
                             </A>
                        </div>
                     </Show>
                ...
                <button
                    class="md:hidden p-4 rounded-2xl hover:bg-muted/50 transition-all active:scale-95 group"
            ...
            <Show when=move || is_open.get()>
                 <div class="md:hidden border-t border-border/50 bg-background/95 backdrop-blur-3xl animate-fade-in overflow-hidden">
                    <div class="container mx-auto px-8 py-10 space-y-4">
                        ...
                        />
                         ...
                         <div class="pt-8 mt-8 border-t border-border/20 flex items-center justify-between">
                            <button
                                on:click=cycle_theme
                                class="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-muted-foreground px-6 py-4 rounded-2xl glass border border-border/20 hover:border-border/40 transition-all"
                            > 
                                <span class="text-lg">
                            ...
                            <A href="/login" on:click=move |_| set_is_open.set(false) class="px-8 py-4 rounded-2xl bg-primary text-primary-foreground text-[10px] font-black uppercase tracking-[0.3em] shadow-2xl hover:scale-105 transition-transform active:scale-95">
                                "Login"
                            </A>
                         </div>
                    </div>
