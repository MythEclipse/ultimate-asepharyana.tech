    ...
    view! {
        <div class="min-h-screen flex flex-col relative overflow-x-hidden bg-background text-foreground transition-colors duration-700">
            ...
            <div class="fixed inset-0 pointer-events-none -z-50 select-none overflow-hidden">
                ...
                <div class="absolute top-[-10%] left-[-5%] w-[60rem] h-[60rem] bg-primary/10 rounded-full blur-[120px] animate-tilt-slow opacity-60" />
                <div class="absolute bottom-[-15%] right-[-10%] w-[70rem] h-[70rem] bg-accent/10 rounded-full blur-[150px] animate-tilt-reverse-slow opacity-40" />
