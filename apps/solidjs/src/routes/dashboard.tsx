...
const quickLinks = [
    { href: "/anime", icon: "📺", label: "Watch Anime", gradient: "from-blue-500 via-purple-500 to-pink-500" },
    { href: "/komik", icon: "📖", label: "Read Komik", gradient: "from-orange-500 via-red-500 to-pink-500" },
    { href: "/chat", icon: "🤖", label: "AI Chat", gradient: "from-green-500 via-teal-500 to-cyan-500" },
    { href: "/project", icon: "💼", label: "Projects", gradient: "from-pink-500 via-rose-500 to-red-500" }
];
            ...
            <Show when={!loading() && user()}>
                <main class="min-h-screen bg-background text-foreground p-4 md:p-8 relative overflow-hidden">
                    ...
                    <div class="fixed inset-0 overflow-hidden pointer-events-none">
                        ...
                        <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 rounded-full blur-3xl animate-float" style={{ "animation-delay": "-3s" }} />
                    </div>
                    ...
                    <div class="max-w-6xl mx-auto relative z-10">
                        ...
                        >
                            <div>
                                <p class="text-sm text-muted-foreground mb-1">{getGreeting()}</p>
                                ...
                                {(stat, index) => (
                                    ...
                                    >
                                        <div class="glass-card rounded-2xl p-6 hover:scale-[1.02] transition-all duration-300">
                                            {/* Glow effect */}
                                            <div class={`absolute inset-0 rounded-2xl bg-gradient-to-r ${stat.gradient} opacity-0 group-hover:opacity-10 blur-xl transition-opacity duration-300`} />

                                            <div class="relative flex items-center gap-4">
                                                <div class={`p-3 rounded-xl bg-gradient-to-br ${stat.gradient} text-white shadow-lg`}>
                                                    {stat.icon}
                                                </div>
                                                <div>
                        ...
                        >
                            ...
                            <div class="glass-card rounded-2xl p-8 text-center">
                                ...
                                <p class="text-sm text-muted-foreground/70 mt-1">Start exploring to see your activity here</p>
                            </div>
                        </Motion.div>
                    </div>
                </main>
