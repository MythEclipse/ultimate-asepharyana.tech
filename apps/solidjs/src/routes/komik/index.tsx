    ...
    >
      ...
      >
        ...
        <div class="absolute top-3 right-3">
          <span
            class={`px-3 py-1.5 rounded-lg text-xs font-bold shadow-lg backdrop-blur-sm ${
              props.item.type === 'Manga'
                ? 'bg-orange-500/90 text-white'
                : props.item.type === 'Manhwa'
                  ? 'bg-blue-500/90 text-white'
                  : props.item.type === 'Manhua'
  ...
  return (
    ...
    >
      <div class="flex items-center gap-3">
        <div
          class={`w-12 h-12 rounded-xl bg-gradient-to-br ${props.gradient} flex items-center justify-center text-2xl shadow-lg`}
        >
          {props.emoji}
        </div>
        <h2
          class={`text-2xl font-bold bg-gradient-to-r ${props.gradient} bg-clip-text text-transparent`}
        >
          {props.title}
        </h2>
      </div>
          ...
          <div class="relative z-10 p-4 md:p-8 lg:p-12 max-w-7xl mx-auto">
            ...
            >
              <A
                ...
                class="px-6 py-3 rounded-xl glass-subtle hover:bg-orange-500/20 hover:text-orange-500 transition-all duration-300 font-medium"
              >
                📚 All Manga
              </A>
              <A
                href="/komik/manhwa/page/1"
                class="px-6 py-3 rounded-xl glass-subtle hover:bg-blue-500/20 hover:text-blue-500 transition-all duration-300 font-medium"
              >
                🇰🇷 All Manhwa
              </A>
              <A
                href="/komik/manhua/page/1"
                class="px-6 py-3 rounded-xl glass-subtle hover:bg-red-500/20 hover:text-red-500 transition-all duration-300 font-medium"
              >
                🇨🇳 All Manhua
              </A>
            </Motion.div>
            ...
            <section class="mb-16">
              ...
              <Suspense fallback={<KomikGrid items={[]} loading={true} />}>
                ...
                <Show when={data()?.manga}>
                  {(mangaData) => (
                    <KomikGrid items={mangaData().data.slice(0, 6)} />
                  )}
                </Show>
              </Suspense>
            </section>
            ...
            <section class="mb-16">
              ...
              <Suspense fallback={<KomikGrid items={[]} loading={true} />}>
                ...
                <Show when={data()?.manhwa}>
                  {(manhwaData) => (
                    <KomikGrid items={manhwaData().data.slice(0, 6)} />
                  )}
                </Show>
              </Suspense>
            </section>
            ...
            <section class="mb-16">
              ...
              <Suspense fallback={<KomikGrid items={[]} loading={true} />}>
                ...
                <Show when={data()?.manhua}>
                  {(manhuaData) => (
                    <KomikGrid items={manhuaData().data.slice(0, 6)} />
                  )}
                </Show>
              </Suspense>
            </section>
