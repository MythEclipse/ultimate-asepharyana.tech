...
async function fetchChapter(slug: string): Promise<ChapterResponse> {
  return httpClient.fetchJson<ChapterResponse>(
    `/api/komik/chapter?chapter_url=${encodeURIComponent(slug)}`,
  );
}
                  ...
                  <div class="glass-subtle bg-black/80 backdrop-blur-xl border-b border-white/10">
                    <div class="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
                      ...
                      <div class="flex items-center gap-3 flex-1 min-w-0">
                        <A
                          href={response().data.list_chapter || '/komik'}
                        ...
                        <h1 class="text-sm md:text-base font-medium truncate">
                          {response().data.title}
                        </h1>
                      </div>
