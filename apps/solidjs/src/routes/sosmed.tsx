    ...
    <>
      ...
      <main class="min-h-screen bg-background text-foreground p-4 md:p-8 lg:p-12 relative overflow-hidden">
        ...
        <div class="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            class="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-blue-500/20 to-cyan-500/20 rounded-full blur-3xl animate-float"
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p class="text-muted-foreground max-w-xl mx-auto mb-12">
              Download content from your favorite social media platforms. Free
              and easy to use.
            </p>
          </Motion.div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <For each={tools}>
              {(tool, index) => (
                ...
                >
                  <div
                    class={`relative p-8 rounded-2xl bg-gradient-to-br ${tool.gradient} text-white overflow-hidden shadow-xl ${tool.shadow} hover:scale-[1.03] transition-all duration-300`}
                  >
