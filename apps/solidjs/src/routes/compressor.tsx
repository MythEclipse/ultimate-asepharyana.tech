...
export default function CompressorPage() {
    ...
    const compressImage = async (file: File, quality: number): Promise<CompressedImage> => {
            ...
            <main class="min-h-screen bg-background text-foreground p-4 md:p-8 lg:p-12">
                <div class="max-w-4xl mx-auto">
                    ...
                    >
                        ...
                        <h1 class="text-4xl font-bold gradient-text mb-2">Image Compressor</h1>
                    ...
                    >
                        <label
                            class={`relative block p-12 rounded-2xl border-2 border-dashed transition-all cursor-pointer ${isDragging()
                            ...
                            <div class="text-center">
                                <Show when={isProcessing()} fallback={
                                    <>
                                        ...
                                        <p class="text-lg font-medium mb-1">Drop your images here</p>
                            ...
                            <div class="flex items-center justify-between mb-6">
                                <div class="flex items-center gap-4">
                                    <div class="glass-subtle px-4 py-2 rounded-lg">
                                        ...
                                        <span class="font-bold text-green-500">{totalSaved().toFixed(1)}%</span>
                                    </div>
                                    <span class="text-sm text-muted-foreground">{images().length} image(s)</span>
                                </div>
                                        ...
                                        <div class="glass-card rounded-xl p-4 flex items-center gap-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div class="flex items-center gap-3 text-sm">
                                                    <span class="text-muted-foreground line-through">{formatSize(img.originalSize)}</span>
                                                    <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                                    </svg>
                                                    <span class="text-green-500 font-medium">{formatSize(img.compressedSize)}</span>
