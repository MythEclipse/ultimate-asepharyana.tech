          ...
          <div class="max-w-4xl mx-auto space-y-4">
            <Show when={messages().length === 0}>
              ...
              >
                ...
                <h2 class="text-2xl font-bold mb-3 gradient-text">
                  Start a conversation
                </h2>
                <p class="text-muted-foreground max-w-md mx-auto">
                  Ask me anything! I can help with coding, writing, analysis,
                  and more.
                </p>
              ...
              {(message, index) => (
                ...
                >
                  <div class="group relative">
                    <div
                      class={`max-w-[85%] md:max-w-[75%] p-4 rounded-2xl ${
                        message.role === 'user'
              ...
              >
                <div class="glass-card p-4 rounded-2xl rounded-bl-md">
                  <div class="flex gap-1.5">
                    ...
                    />
                    <div
                      class="w-2.5 h-2.5 rounded-full bg-neon-cyan animate-bounce"
