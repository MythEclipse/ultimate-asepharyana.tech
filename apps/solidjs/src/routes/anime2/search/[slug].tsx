...
async function searchAnime(query: string): Promise<SearchResponse> {
    return httpClient.fetchJson<SearchResponse>(`/api/anime2/search?q=${encodeURIComponent(query)}`);
}

export default function Anime2SearchPage() {
    ...
    return (
        <>
            <Title>Search: {query()} | Anime2 | Asepharyana</Title>
