        ...
        <>
            ...
            <main class="p-4 md:p-8 lg:p-12 bg-background text-foreground min-h-screen">
                <div class="max-w-7xl mx-auto">
                    ...
                    {/* Search Bar */}
                    <div class="mb-8">
                        <form action="/anime2/search" method="get" class="flex gap-2">
                            <input
                                type="text"
                                name="q"
                            ...
                            {(animeData) => (
                                <div class="space-y-12">
                                    ...
                                    <section>
                                        <div class="flex items-center justify-between mb-6">
                                            ...
                                            <A
                                                ...
                                                class="flex items-center gap-2 text-purple-600 dark:text-purple-400 hover:text-purple-700 transition-colors"
                                            >
                                                View All
                                    ...
                                    <section>
                                        <div class="flex items-center justify-between mb-6">
                                            <div class="flex items-center gap-3">
                                                <div class="p-3 bg-pink-100 dark:bg-pink-900/50 rounded-xl">
                                                    <svg class="w-6 h-6 text-pink-600 dark:text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                    </svg>
                                                </div>
                                                <h2 class="text-2xl font-bold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">
                                                    Complete Anime
                                                </h2>
                                            </div>
                                            <A
                                                href="/anime2/complete-anime/1"
                                                class="flex items-center gap-2 text-pink-600 dark:text-pink-400 hover:text-pink-700 transition-colors"
                                            >
                                                View All
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
