          ...
          <Show when={data.error}>
            ...
            >
              <div class="max-w-md mx-auto glass-card rounded-3xl p-12">
                ...
                <A
                  href="/anime"
                  class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
                >
                  ← Kembali
                </A>
              </div>
                      ...
                      <div class="space-y-3">
                        <Show when={detailData().data.status}>
                          <div class="flex items-center gap-3">
                            <span class="w-10 h-10 rounded-xl bg-green-500/20 flex items-center justify-center text-lg">
                              🟢
                            </span>
                            <div>
                        ...
                        <Show when={detailData().data.episode_lists?.length}>
                          <div class="flex items-center gap-3">
                            <span class="w-10 h-10 rounded-xl bg-blue-500/20 flex items-center justify-center text-lg">
                              🎬
                            </span>
                            <div>
                              <p class="text-xs text-muted-foreground">
                              ...
                              <p class="font-semibold">
                                {detailData().data.episode_lists.length} eps
                              </p>
                            </div>
                          </div>
                        </Show>
                        ...
                        <Show when={detailData().data.studio}>
                          <div class="flex items-center gap-3">
                            <span class="w-10 h-10 rounded-xl bg-pink-500/20 flex items-center justify-center text-lg">
                              🏢
                            </span>
                            <div>
                              <p class="text-xs text-muted-foreground">
                        ...
                        <Show when={detailData().data.release_date}>
                          <div class="flex items-center gap-3">
                            <span class="w-10 h-10 rounded-xl bg-orange-500/20 flex items-center justify-center text-lg">
                              📅
                            </span>
                            <div>
                  ...
                  <div class="flex-1 space-y-8">
                    ...
                    >
                      <h3 class="font-bold text-xl mb-4 flex items-center gap-3">
                        <span class="w-10 h-10 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white">
                          📖
                        </span>
                        Sinopsis
                      </h3>
                    ...
                    >
                      <h2 class="text-2xl md:text-3xl font-bold mb-6 flex items-center gap-3">
                        <span class="w-12 h-12 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white text-xl shadow-lg">
                          🎬
                        </span>
                        Daftar Episode
