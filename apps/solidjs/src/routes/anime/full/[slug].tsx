          ...
          <Show when={data.error}>
            <div class="p-8 text-center">
              <div class="max-w-md mx-auto glass-card rounded-2xl p-8">
                ...
                <p class="text-destructive font-medium mb-4">
                  Failed to load episode
                </p>
                <A href="/anime" class="text-primary hover:underline">
                  ← Back to Anime
                </A>
              </div>
            </div>
            ...
            {(episodeData) => (
              ...
              >
                ...
                <div class="flex items-center justify-between gap-4 glass-card rounded-xl p-4 mb-6">
                  <Show
                    when={
                      episodeData().data.has_previous_episode &&
                      episodeData().data.previous_episode
                    }
                    fallback={<div />}
                  >
                    <A
                  ...
                  <Show
                    when={
                      episodeData().data.has_next_episode &&
                      episodeData().data.next_episode
                    }
                  >
                    <A
                ...
                <Show
                  when={
                    episodeData().data.download_urls &&
                    Object.keys(episodeData().data.download_urls!).length > 0
                  }
                >
                  <div class="glass-card rounded-2xl overflow-hidden">
                    ...
                    <div class="p-5 space-y-5">
                      <For
                        each={Object.entries(episodeData().data.download_urls!)}
                      >
                        {([resolution, servers]) => (
                          <div class="bg-white/5 rounded-xl p-4 border border-white/5">
                            ...
                            <div class="flex items-center gap-3 mb-4">
                              <div
                                class={`px-3 py-1.5 rounded-lg font-bold text-sm ${
                            ...
                            <div class="flex flex-wrap gap-2">
                              <For each={servers}>
                                {(dl) => (
                                  ...
                                  >
                                    <svg
                                      class="w-4 h-4 text-muted-foreground group-hover:text-primary-foreground transition-colors"
                                      fill="none"
                                      viewBox="0 0 24 24"
                                      stroke="currentColor"
                                    >
