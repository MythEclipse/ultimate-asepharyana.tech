            ...
            <Show when={!loading() && !user()}>
                <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
                    ...
                    <div class="fixed inset-0 overflow-hidden pointer-events-none">
                        ...
                        <div class="absolute bottom-1/4 -left-20 w-96 h-96 bg-gradient-to-tr from-cyan-500/30 to-blue-500/30 rounded-full blur-3xl animate-float" style={{ "animation-delay": "-4s" }} />
                            ...
                            <div class="p-8">
                                ...
                                <form onSubmit={handleSubmit} class="space-y-5">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative group">
                                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                <svg class="h-5 w-5 text-muted-foreground group-focus-within:text-primary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button
                                        ...
                                        style={{ "background-size": "200% 100%", transition: "all 0.5s ease" }}
                                    >
                                        {isLoading() ? (
                                            <>
