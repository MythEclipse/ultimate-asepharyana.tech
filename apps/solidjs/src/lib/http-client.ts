...
const RUST_API =
  import.meta.env.VITE_RUST_API ||
  (isDev ? 'http://localhost:4091' : 'https://rust.asepharyana.tech');
const ELYSIA_API =
  import.meta.env.VITE_ELYSIA_API ||
  (isDev ? 'http://localhost:4092' : 'https://elysia.asepharyana.tech');
