...
use crate::routes::api::komik::KomikApiDoc;
use crate::routes::api::anime::AnimeApiDoc;
use crate::routes::api::anime2::Anime2ApiDoc;
...
#[openapi(
    ...
    nest(
        path = "/api/komik", api = KomikApiDoc
    ),
    nest(
        path = "/api/anime", api = AnimeApiDoc
    ),
    nest(
        path = "/api/anime2", api = Anime2ApiDoc
    )
)]
pub struct ApiDoc;
