...
#[allow(dead_code)]
pub const ENDPOINT_PATH: &str = "/api/komik2/manhwa";
#[allow(dead_code)]
...
pub async fn list(
  ...
  let url = if page == 1 {
    "https://komiku.org/pustaka/?tipe=manhwa".to_string()
  } else {
    format!("https://komiku.org/pustaka/page/{}/?tipe=manhwa", page)
  };
