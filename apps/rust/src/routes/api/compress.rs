//! Handler for the compress endpoint.
    ...
    pub const ENDPOINT_DESCRIPTION: &str = "Handles GET requests for the compress endpoint.";
    ...
    /// Response structure for the Compress endpoint.
    ...
    responses(
        (status = 200, description = "Handles GET requests for the compress endpoint.", body = ListResponse),
...
pub async fn compress() -> impl IntoResponse {
    ...
    /// Handles GET requests for the compress endpoint.
