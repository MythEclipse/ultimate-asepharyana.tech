...
lazy_static! {
    ...
    static ref ALTERNATIVE_TITLE_SELECTOR: Selector =
        Selector::parse(".spe span:contains('Judul Alternatif:')").unwrap();
    ...
    static ref DESCRIPTION_SELECTOR: Selector =
        Selector::parse("#sinopsis > section > div > div.entry-content.entry-content-single > p")
            .unwrap();
    static ref STATUS_SELECTOR: Selector =
        Selector::parse(".spe span:contains('Status:')").unwrap();
    static ref GENRE_SELECTOR: Selector = Selector::parse(".genre-info a").unwrap();
    static ref RELEASE_DATE_SELECTOR: Selector =
        Selector::parse("#chapter_list > ul > li:last-child > span.dt").unwrap();
    static ref AUTHOR_SELECTOR: Selector =
        Selector::parse(".spe span:contains('Pengarang:')").unwrap();
    static ref TYPE_SELECTOR: Selector =
        Selector::parse(".spe span:contains('Jenis Komik:') a").unwrap();
    static ref TOTAL_CHAPTER_SELECTOR: Selector =
        Selector::parse("#chapter_list > ul > li:nth-child(1) > span.lchx").unwrap();
    static ref UPDATED_ON_SELECTOR: Selector =
        Selector::parse("#chapter_list > ul > li:nth-child(1) > span.dt").unwrap();
