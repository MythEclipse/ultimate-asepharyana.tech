...
const ENDPOINT_PATH: &str = "/api/komik/manhua";
const ENDPOINT_DESCRIPTION: &str = "Fetches manhua list, parses HTML, and returns JSON response.";
const ENDPOINT_TAG: &str = "komik";
const SUCCESS_RESPONSE_BODY: &str = "ManhuaListResponse";
...
pub async fn manhua_handler(Query(params): Query<Params>) -> impl IntoResponse {
