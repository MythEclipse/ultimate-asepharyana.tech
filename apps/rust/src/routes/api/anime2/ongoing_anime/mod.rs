...
const ENDPOINT_PATH: &str = "/api/anime2/ongoing-anime/{slug}";
const ENDPOINT_DESCRIPTION: &str = "Fetches a paginated list of ongoing anime from alqanime.net";
...
/// Fetches a paginated list of ongoing anime from alqanime.net
#[utoipa::path(get, path = "/api/anime2/ongoing-anime/{slug}", tag = "anime2", responses((status = 200, description = "Success", body = OngoingAnimeResponse), (status = 500, description = "Internal Server Error")), params(("slug" = String, Path, description = "Slug for pagination (page number).")))]
