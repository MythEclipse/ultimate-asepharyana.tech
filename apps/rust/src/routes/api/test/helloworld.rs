//! Handler for the helloworld endpoint.
    ...
    pub const ENDPOINT_DESCRIPTION: &str = "Handles GET requests for the test/helloworld endpoint.";
    pub const ENDPOINT_TAG: &str = "test.helloworld";
    pub const OPERATION_ID: &str = "test_helloworld";
    pub const SUCCESS_RESPONSE_BODY: &str = "Json<ListResponse>";

    /// Response structure for the Helloworld endpoint.
    ...
    tag = "test.helloworld",
    operation_id = "test_helloworld",
    responses(
        (status = 200, description = "Handles GET requests for the test/helloworld endpoint.", body = ListResponse),
...
pub async fn helloworld() -> impl IntoResponse {
    ...
    /// Handles GET requests for the test/helloworld endpoint.
