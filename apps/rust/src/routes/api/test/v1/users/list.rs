//! Handler for the list endpoint.
    ...
    pub const ENDPOINT_PATH: &str = "/test/v1/users/list";
    pub const ENDPOINT_DESCRIPTION: &str = "Retrieves a list of users.";
    pub const ENDPOINT_TAG: &str = "test/v1/users/list";
    pub const OPERATION_ID: &str = "test/v1/users/list";
    ...
    #[utoipa::path(
        ...
        path = "/test/v1/users/list",
        tag = "test/v1/users/list",
        operation_id = "test/v1/users/list",
        responses(
