//! Handler for the list endpoint.
    ...
    pub const ENDPOINT_PATH: &str = "/test/v1/list";
    pub const ENDPOINT_DESCRIPTION: &str = "Retrieves a list of v1.";
    pub const ENDPOINT_TAG: &str = "test.v1.list";
    pub const OPERATION_ID: &str = "test_v1_list";
    ...
    #[utoipa::path(
    get,
    path = "/api/test/v1/list",
    tag = "test.v1.list",
    operation_id = "test_v1_list",
    responses(
        (status = 200, description = "Retrieves a list of v1.", body = ListResponse),
