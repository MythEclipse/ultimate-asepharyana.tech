...
use axum::{response::IntoResponse, routing::get, Json, Router};
    ...
    pub const ENDPOINT_PATH: &str = "/test/v3/protected/users/list";
    pub const ENDPOINT_DESCRIPTION: &str = "Retrieves a list of users.";
    pub const ENDPOINT_TAG: &str = "test/v3/protected/users/list";
    pub const OPERATION_ID: &str = "test/v3/protected/users/list";
    ...
    #[utoipa::path(
        ...
        path = "/test/v3/protected/users/list",
        tag = "test/v3/protected/users/list",
        operation_id = "test/v3/protected/users/list",
        responses(
            (status = 200, description = "Retrieves a list of users.", body = ListResponse),
